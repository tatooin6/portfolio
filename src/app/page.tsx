  ...
  return (
    <main className="flex flex-col items-center justify-start p-24">
      <div className="z-10 w-full max-w-5xl flex flex-col items-center justify-center font-mono text-sm">
        ...
        <p className="text-xl lg:static flex w-full justify-start bg-gradient-to-b pb-6 pt-8 backdrop-blur-2xl dark:from-inherit dark:text-gray-200 lg:rounded-xl lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
