  ...
  return (
    <div className="px-2 w-full flex lg:flex-row flex-col dark:text-gray-200">
      <div className="lg:w-1/2 w-full p-2">
        ...
        >
          <p>
            Hi there! I&apos;m Antonio Pantoja, also known as Tato. I hold a
            degree in Computer Science from La Paz, Bolivia, and have over 4
            years of experience as a Full Stack Web Developer. Throughout my
          ...
          <p className="mt-4">
            ...
            development with .NET Core, C#, and NodeJS, and I&apos;ve worked on
          ...
          <p className="mt-4">
            ...
            contributing to the Web Development Community. Check out the Blog
            section of this page for tips, tutorials, and insights that might
